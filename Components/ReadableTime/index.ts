import Return, { milliseconds } from "./types/function";

/**
 * Converts milliseconds to a human-readable time duration.
 *
 * @param {milliseconds} milliseconds - The number of milliseconds to convert.
 *
 * @returns {{
 *  specific: {
 *      year: number,
 ...
 */
export function ReadableTime(milliseconds: milliseconds): Return {
  let year: number,
    month: number,
    day: number,
    hour: number,
